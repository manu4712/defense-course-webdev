...
form.addEventListener("submit", (e) => {
  ...
  result.textContent = `Hi, ${firstName} ${surName}. Your zodiac sign is ${
    zodiacSigns[(firstName.length + surName.length) % 12]
  }, ${compliments[day]} ${victimCardCompliments[year % 20]} ${
    recommendations[(day + month) % 30]
  } ${predictions[(day + month + year) % 20]}`;
